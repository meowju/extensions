...
import { runLeanAgent, type AgentResult } from "../../agent-kernel/src/core/lean-agent";
...
export type SubAgentType = "researcher" | "coder" | "reviewer";
...
Sub-agent types:
- "researcher": Web search, document analysis, capability research
- "coder": Code generation, modification, implementation
- "reviewer": Code review, quality assessment, test validation
...
[
  {
    "id": "task-1",
    "type": "research|coder|reviewer|general",
