...
export class Logger {
  ...
  constructor(context: string = 'app') {
    ...
    try {
      ...
      this.logLevel = LogLevel[logCfg.level.toUpperCase() as keyof typeof LogLevel] ?? LogLevel.INFO;
      this.enableFile = logCfg.enableFile;
      this.enableConsole = logCfg.enableConsole;
      this.logFilePath = logCfg.filePath;
