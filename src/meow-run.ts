...
// Agent kernel paths: check kernel package first, then agent-kernel symlink
const KERNEL_PATH = join(__dirname, "..", "..", "..", "kernel", "src", "core", "lean-agent.ts");
const AGENT_KERNEL_PATH = join(__dirname, "..", "agent-kernel", "src", "core", "lean-agent.ts");
const LEAN_AGENT = existsSync(KERNEL_PATH) ? KERNEL_PATH : AGENT_KERNEL_PATH;
